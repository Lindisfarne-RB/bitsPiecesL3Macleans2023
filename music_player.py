...
import os
import pygame
#if pygame is giving error pip install pygame then try this python -m pip install pygame
...
if __name__ == '__main__':
    ...
    Label(root, text="Created By so and so ", font="lucida 10", bg="grey", fg="white").pack(fill=X, pady=25)
    Label(root, text="#CodeWithMe", font="lucida 10", bg="black", fg="white").pack()
